...
const OrderSummary: React.FC<OrderSummaryProps> = ({ onSubmit }) => {
    ...
    const total_service_fee = Number(files!.reduce((acc: any, file: { service_fee: any; }) => acc + file.service_fee, 0).toFixed(8)) * 100000000;
    const total_content_fee = files!.reduce((acc: any, file: { content_fee: any; }) => acc + file.content_fee, 0);
            ...
            <div>
                <div>
                    <div className='p-4'>
                        ...
                        <Typography
                            ...
                            Fees are an estimate and the final cost may vary.
                        </Typography>
                ...
                <div className="m-4 w-48 ">
                    ...
                    <div className="flex">
                        <Input
                            ...
                            labelProps={{
                                className: "",
                            }} crossOrigin={undefined}                        // TODO add error logic
                        />
                        <Typography variant='small' className='h-8 ml-4 mb-2 block font-medium  text-blue-500' placeholder={undefined}>
                            Credit Applied
                        </Typography>
                ...
                <div className="m-4 mt-0 w-96">
                    ...
                    <Typography
                        variant="small"
                        color="gray"
                        className="mt-2 flex items-center gap-1 font-normal" placeholder={undefined}                    >
