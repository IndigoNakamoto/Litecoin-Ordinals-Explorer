...
interface InscriptionHeroProps {
...
export const InscriptionHero: React.FC<InscriptionHeroProps> = ({
    inscription_id,
    inscription_number,
    content_type,
    maxHeight = "900px",
    ...
    return (
        <div className="overflow-hidden shadow-lg cursor-pointer transition-transform duration-200 ease-in-out hover:scale-105 min-w-full">
            <Link href={`/${inscription_number}`} target="_blank" rel="noopener">
                <div 
                    className={`aspect-w-1 aspect-h-1 min-w-full min-h-[700px] overflow-hidden rounded-3xl bg-gradient-to-br from-gray-800 to-transparent flex items-center justify-center relative`}
