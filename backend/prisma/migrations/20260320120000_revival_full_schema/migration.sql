-- Revival: drop legacy artifacts from initial migration, align DB with schema.prisma
DROP MATERIALIZED VIEW IF EXISTS "mv_inscriptions_video" CASCADE;
DROP MATERIALIZED VIEW IF EXISTS "mv_inscriptions_audio" CASCADE;
DROP TABLE IF EXISTS "inscriptions" CASCADE;
DROP TABLE IF EXISTS "update_progress" CASCADE;
